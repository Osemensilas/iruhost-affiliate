...
export default function Home() {
  return (
    <>
    {/* Hero Section Begins */}
    <section className="sm:h-screen h-max py-20 sm:py-0 w-full sm:px-10 px-4">
      <div className="h-full w-full flex sm:flex-row flex-col items-center gap-2">
        <div className="h-max sm:w-3/5 w-full">
        ...
        <div className="h-137.5 sm:w-2/5 w-full">
